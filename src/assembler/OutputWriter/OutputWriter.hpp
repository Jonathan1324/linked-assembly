...
namespace Output
{
    ...
    Writer* getWriter(const Context& context, Architecture arch, BitMode bits, Format format, std::ofstream& file, const Parser::Parser* parser, const Encoder::Encoder* encoder);
}