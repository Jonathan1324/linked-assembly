...
mkdir -p logs/assembler/nasm-srcs

rm -f logs/assembler/nasm-srcs/test.asm-32bit-bin.txt
rm -f logs/assembler/nasm-srcs/test.asm-64bit-bin.txt
rm -f logs/assembler/nasm-srcs/test.asm-32bit-elf.txt
rm -f logs/assembler/nasm-srcs/test.asm-64bit-elf.txt
...
nasm -f bin tests/assembler/srcs/test.asm -o tests/assembler/build/nasm/test-32bit-bin.bin >> logs/assembler/nasm-srcs/test.asm-32bit-bin.txt 2>&1
nasm -f bin tests/assembler/srcs/test.asm -o tests/assembler/build/nasm/test-64bit-bin.bin >> logs/assembler/nasm-srcs/test.asm-64bit-bin.txt 2>&1
nasm -f elf32 tests/assembler/srcs/test.asm -o tests/assembler/build/nasm/test-32bit-elf.o >> logs/assembler/nasm-srcs/test.asm-32bit-elf.txt 2>&1
nasm -f elf64 tests/assembler/srcs/test.asm -o tests/assembler/build/nasm/test-64bit-elf.o >> logs/assembler/nasm-srcs/test.asm-64bit-elf.txt 2>&1
...
objdump --all-headers tests/assembler/build/test.asm-x86-32bit-elf.o >> logs/assembler/elf/test-32bit-objdump.txt 2>&1
objdump --all-headers tests/assembler/build/test.asm-x86-64bit-elf.o >> logs/assembler/elf/test-64bit-objdump.txt 2>&1
